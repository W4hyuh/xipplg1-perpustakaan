...
<head>
    ...
    <title>Petugas Dashboard - Perpustakaan SMKN 7 Samarinda</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../petugas/siswa/siswa.php">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div class="welcome-text">
                    ...
                    <span>Selamat Datang, <?= $_SESSION['name'] ?? 'Petugas' ?></span>
                </div>
