...
<head>
    ...
    <title>Tambah Buku - Perpustakaan SMKN 7 Samarinda</title>
        ...
        <div class="register-card" data-aos="fade-up">
            ...
            <div class="register-body">
                <form action="" method="POST">
                    ...
                    <div class="form-floating">
                        <input type="number" class="form-control" id="tahun_terbit" name="tahun_terbit" placeholder="Tahun Terbit" required>
