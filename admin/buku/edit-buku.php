...
<head>
    ...
    <title>Edit Buku - Perpustakaan SMKN 7 Samarinda</title>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-floating">
                        <select class="form-select" id="nama" name="nama" required>
                            ...
                            ?>
                            <option value="<?= $k['nama']; ?>" <?= $buku['nama'] == $k['nama'] ? 'selected' : ''; ?>><?= $k['nama']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-floating">
                        <input type="number" class="form-control" id="tahun_terbit" name="tahun_terbit" placeholder="Tahun Terbit" value="<?= $buku['tahun_terbit']; ?>" required>
                        <label for="tahun_terbit">Tahun Terbit</label>
                    </div>
                    <div class="form-floating">
                        <input type="number" class="form-control" id="stok" name="stok" placeholder="Stok" value="<?= $buku['stok']; ?>" required>
