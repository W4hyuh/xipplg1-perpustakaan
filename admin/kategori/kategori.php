...
<head>
    ...
    <title>Data Kategori - Perpustakaan SMKN 7 Samarinda</title>
    ...
    <div class="container">
        <div class="table-container" data-aos="fade-up">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="tambah-kategori.php" class="btn-add">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $k['nama']; ?></td>
                            <td>
                                <a href="edit-kategori.php?id=<?= $k['id']; ?>" class="btn-action btn-edit">
                                    <i class="fas fa-edit"></i>
                                    <span>Edit</span>
                                </a>
                                <a href="hapus-kategori.php?id=<?= $k['id']; ?>" class="btn-action btn-delete" onclick="return confirm('Yakin ingin menghapus data ini?')">
