...
$siswa = select("SELECT * FROM user WHERE level='siswa'");
?>
...
<head>
    ...
    <title>Data Siswa - Perpustakaan SMKN 7 Samarinda</title>
    ...
    <div class="container">
        <div class="table-container" data-aos="fade-up">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="tambah-siswa.php" class="btn-add">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $s['password']; ?></td>
                            <td>
                                <span class="status-badge <?= $s['level'] == 'admin' ? 'status-active' : 'status-inactive'; ?>">
                                    <?= ucfirst($s['level']); ?>
                                </span>
                            </td>
                            <td>
                                <span class="status-badge <?= $s['status'] == 'aktif' ? 'status-active' : 'status-inactive'; ?>">
                                    <?= ucfirst($s['status']); ?>
                                </span>
                            </td>
                            <td>
                                <a href="edit-siswa.php?id=<?= $s['id']; ?>" class="btn-action btn-edit">
                                    <i class="fas fa-edit"></i>
                                    <span>Edit</span>
                                </a>
                                <a href="hapus-siswa.php?id=<?= $s['id']; ?>" class="btn-action btn-delete" onclick="return confirm('Yakin ingin menghapus data ini?')">
