...
if (isset($_GET['id'])) {
    $id = (int)$_GET['id'];
    $akun = select("SELECT * FROM user WHERE id=$id")[0];
    if (isset($_POST['ubah'])) {
...
<head>
    ...
    <title>Edit Siswa - Perpustakaan SMKN 7 Samarinda</title>
            ...
            <div class="register-body">
                <form action="" method="POST">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama Lengkap" value="<?= $akun['name']; ?>" required>
                    ...
                    <div class="form-floating">
                        <input type="password" class="form-control" id="password" name="password" placeholder="Password" value="<?= $akun['password']; ?>" required>
                        <label for="password">Password</label>
                    </div>
                    <div class="form-floating">
                        <select class="form-select" id="level" name="level" required>
                            <option value="">pilih level</option>
                            <option value="siswa" <?= $akun['level'] == 'siswa' ? 'selected' : ''; ?>>siswa</option>
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="status" name="status" placeholder="status" value="<?= $akun['status']; ?>" required>
